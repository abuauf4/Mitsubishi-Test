        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-bold text-mitsu-dark font-serif">
              Lineup Niaga{' '}
              <span className="text-red-shimmer italic">Ringan</span>
            </h2>
            <p className="mt-4 text-gray-500 text-base sm:text-lg max-w-xl">
              Triton — double cabin andalan dari Mitsubishi Motor Indonesia.
            </p>
          ...
          >
            {[
              { label: '1 Model', icon: Truck },
              { label: 'Mulai Rp 325 Jt', icon: Sparkles },
              { label: 'MIVEC Turbo Diesel', icon: Zap },
            ].map((stat) => {
          ...
          {/* Niaga Ringan Vehicle Cards Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {niagaRingan.map((vehicle, index) => (
              <VehicleCard
                key={vehicle.slug}
                name={vehicle.name}
