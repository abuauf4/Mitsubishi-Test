      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-100">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold rounded-xl transition-all min-h-[44px] text-sm tracking-wide glow-green"
          >
