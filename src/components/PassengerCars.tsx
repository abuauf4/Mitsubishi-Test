          ...
          {passengerVehicles.map((vehicle, index) => (
            ...
            >
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100">
                {/* Vehicle Image */}
                <div className="relative h-[320px] sm:h-[360px] bg-gradient-to-b from-gray-50 to-white overflow-hidden">
                  <img
                    src={vehicle.image}
                ...
                <div className="p-6">
                  ...
                  {/* CTA */}
                  <button className="mt-6 w-full flex items-center justify-center gap-2 py-3 bg-mitsu-dark hover:bg-mitsu-red text-white font-semibold rounded-lg transition-all duration-300 min-h-[44px] text-sm tracking-wide group-hover:bg-mitsu-red">
                    Lihat Detail
